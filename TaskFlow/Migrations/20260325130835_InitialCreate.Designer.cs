...
namespace TaskFlow.Migrations
{
    ...
    [Migration("20260325130835_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskFlow.Models.RecurringTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("TaskFlow.Models.Subtask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("TaskFlow.Models.RecurringTask", b =>
                {
                    b.HasOne("TaskFlow.Models.TaskItem", "TaskItem")
                        .WithOne("RecurringTask")
                        .HasForeignKey("TaskFlow.Models.RecurringTask", "TaskItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
